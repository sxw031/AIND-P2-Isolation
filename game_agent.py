...
def heuristic3(game, player):
    """
    This heuristic outputs a score equal to the difference in the number of moves
    available to the two players, while penalizing the moves for the
    maximizing player when they are in the corner and rewarding the moves for the
    minimizing player. These penalties/rewards are elevated near the end game through a game state factor.
    """
